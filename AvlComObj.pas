...
begin
  ...
  if (CoInitFlags <> -1) and Assigned(AvlComObj.CoInitializeEx) then
  begin
    NeedToUninitialize := Succeeded(AvlComObj.CoInitializeEx(nil, CoInitFlags));
