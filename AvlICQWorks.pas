unit AvlICQWorks {TICQClient, TICQDb contants & procedures};
...
procedure CreateCLI_ADDVISIBLE(Pkt: PRawPkt; UINs: TStringList; var Seq: Word);
procedure CreateCLI_REMVISIBLE(Pkt: PRawPkt; UIN: LongWord; var Seq: Word);
procedure CreateCLI_ADDINVISIBLE(Pkt: PRawPkt; UINs: TStringList; var Seq: Word);
...
begin
  ...
  PktInit(Pkt, 2, Seq);                         //Channel 2
  PktSnac(Pkt, $13, $1A, 0, 0);                 //Snac: Type x13/x1A, ID x0000, Flags 0
...
procedure CreateCLI_SENDADVMSG_CUSTOM(Pkt: PRawPkt; FFSeq: Word; ITime, IRandom, UIN: LongWord; CMD, MSGTYPE: Byte; ACMD: Word; const Msg: String; Data: Pointer; DataLen: LongWord; RTFFormat: Boolean; var Seq: Word; Accept: Boolean = True);
var
  lpTLV05: TRawPkt;
  lpTLV2711: TRawPkt;
const
...
begin
  PktInit(Pkt, 2, Seq);                         //Channel 2
  PktSnac(Pkt, $04, $06, 0, 0);                 //Snac: Type x04/x06, ID x0000, Flags 0
  PktInt(Pkt, ITime, 4);                        //Seems to be a time stamp in 1/1500 sec since 8am of that Sunday.
  ...
  PktInt(@lpTLV2711, $0008, 2);                 //This is the version of the TCP protocol that the sending client uses.
...
procedure CreateCLI_SENDMSG_ADVANCED(Pkt: PRawPkt; ITime, IRandom, UIN: LongWord; const Msg: String; RTFFormat: Boolean; var Seq: Word);
begin
  CreateCLI_SENDADVMSG_CUSTOM(Pkt, $FFFF, ITime, IRandom, UIN, $01, $00, $0001, Msg, nil, 0, RTFFormat, Seq, True);
end;
...
var
  ...
  tag: Boolean;
  st: String;
  procedure ReplaceAll(RepWhat, RepTo: string);
  var
    p: Integer;
  begin
    p := pos(RepWhat, Value);
    while p > 0 do begin
      Value := Copy(Value, 1, p - 1) + RepTo + Copy(Value, p + 2, Length(Value));
      p := pos(RepWhat, Value);
    end;
  end;
begin
